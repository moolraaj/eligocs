        ...
        <>
            <form id='applyforjob'>
                <div className="job_form_flex_wrapper">
                    ...
                    <div className="form_fields_wrapper">
                        <input type="email" name="email" placeholder='Email' value={user.youremail} onChange={getUserData} />
                    ...
                    <div className="form_fields_wrapper">
                        ...
                        {errors.phonenumber && <span className='error_fields'>phonenumber is required</span>}
                    </div>
