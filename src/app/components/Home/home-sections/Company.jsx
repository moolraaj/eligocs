              ...
              <div className="home_company_wrapper">
                <div className="company_flex">
                  <div className="company_left_section">
                    ...
                    <h1 style={{width: '100%', height: '100%', minHeight: '100px'}}
                      dangerouslySetInnerHTML={{
                        __html: ele.acf.our_company_heading,
                      }}></h1>


                    <p style={{width: '100%', height: '100%', minHeight: '100px'}}>{ele.acf.our_company_para}</p>
                  </div>
                      ...
                      <div className="company_scroll_wrapper" key={index}>
                        <div className="company_faq_wrapper">
                          <div
                            ...
                            <h4 style={{width: '100%', height: '100%', minHeight: '100px'}}>{items.faq_question}</h4>
                            <i
                          ...
                          {activeIndex === index && (
                            <div className="company_answers">
                              <p style={{width: '100%', height: '100%', minHeight: '100px'}}>{items.faq_answer}</p>
                            </div>
                          )}
                        </div>
                      </div>
